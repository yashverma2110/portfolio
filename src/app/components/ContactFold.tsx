    ...
    <div className="py-20 flex flex-col gap-4">
      ...
      <section className="w-full text-white flex flex-col gap-4 font-semibold">
        <div className="flex items-center text-sm md:text-base gap-2">
          ...
          <h3><span className="hidden md:inline">Let&apos;s Connect on </span>LinkedIn <span className="inline md:hidden">Profile</span> @</h3>
          <Link href={CONTACT.linkedin} target="_blank" className="bg-slate-500 whitespace-nowrap text-sm rounded p-2 w-fit flex items-center gap-2">
            <FaLinkedin />
